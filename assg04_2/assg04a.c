...
char* add(char *a , char *b ,char c)// Adding or Subtracting Two Numbers
{
...
{
	int al,bl;
	al  =strlen(a); // Calculating Length of Both Dtrins and equalling the Length by adding 0 in front of string
	bl = strlen(b);
	if(al > bl)
	{
